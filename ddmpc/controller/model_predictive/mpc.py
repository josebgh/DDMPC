...
>>>>>>> 083bbdc5f680b54ef0017bfa179538bd2bf9f3e2
...
=======
        ...
        if self.eng is None:
            self.eng = matlab.engine.start_matlab()
        self.eng.workspace['par_vals'] = par_vals
        # self.eng.workspace['nlp'] = self.nlp
        # self.eng.workspace['forecast'] = forecast
        # self.eng.workspace['current_time'] = current_time
        # self.eng.run('matlab_mpc_aux.m', nargout=0)
>>>>>>> 083bbdc5f680b54ef0017bfa179538bd2bf9f3e2
